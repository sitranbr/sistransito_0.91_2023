...
public class SyncFiles {
        ...
        stringRequest = new StringRequest(Request.Method.POST, WebClient.URL_REQUEST_SSL,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (isSuccess.equals("true")) {
                                Log.v("Response: ", String.valueOf(isSuccess));
            ...
            protected Map<String, String> getParams() {
                String root = Environment.getExternalStorageDirectory().toString() + "/" +
                        context.getApplicationContext().getString(R.string.folder_app) + "/";
                ...
                // Recuperar todas as fotos da nova tabela
                List<String> photoPaths = DatabaseCreator
                        .getInfractionDatabaseAdapter(context.getApplicationContext())
                        .getAitPhotos(ait);

                Map<String, String> params = new HashMap<>();

                // Adicionar dados da infração
                ...
                // Adicionar fotos dinamicamente
                int photoIndex = 1;
                for (String photoPath : photoPaths) {
                    if (photoPath != null) {
                        Bitmap bitmap = BitmapFactory.decodeFile(photoPath);
                        String stringImage = Routine.getStringImage(bitmap);
                        String photoName = photoPath.substring(lengthRoot); // Nome relativo da foto
                        params.put("foto" + photoIndex, photoName);
                        params.put("image" + photoIndex, stringImage);
                        photoIndex++;
                    }
                }
    ...
    public void sendAitData2(final String ait){
